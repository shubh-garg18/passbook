@echo off
rem Windows stop launcher. Double-click this file in Explorer. SPEC §22.4.
rem
rem Explorer runs a .cmd from its own folder, but a shortcut may not, so it cds
rem to itself anyway. Everything else is scripts\stop.py, shared with the
