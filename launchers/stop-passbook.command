#!/bin/bash
# macOS stop launcher. Double-click this file in Finder. SPEC §22.4.
#
# Finder runs a .command from the user's home directory, not from the file's own
# folder, so the first thing it does is cd to the project root above it. Everything else is
# scripts/stop.py, which is shared with the Windows and Linux launchers.
#
